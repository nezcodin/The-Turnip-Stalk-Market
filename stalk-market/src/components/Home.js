        ...
        <div className='p-10 flex flex-row justify-evenly'>
          <div className='bg-skyblue text-white rounded-xl w-auto p-10 flex-wrap max-w-screen-md h-92'>
            <div className='flex flex-col'>
              <h2 className='text-4xl py-2'>Welcome back to The Turnip Stalk Market!</h2>
          ...
          <div className='items-center flex -m-px'>
            <div className='p-4 flex flex-col justify-center items-center'>
              <h2 className='text-sienna text-5xl p-8 text-center'>Hey, {props.username}! Check out the following:</h2>
              <Link to='/profile'><button className='m-6 bg-vividorange text-white p-3 rounded-lg font-finkheavy text-xl w-40 hover:bg-orangehover'>My Profile</button></Link>
              <Link to='/postings'><button className='m-6 bg-vividorange text-white p-3 rounded-lg font-finkheavy text-xl w-40 hover:bg-orangehover'>Latest Posts</button></Link>
              <Link to='/calculator'><button className='m-6 bg-vividorange text-white p-3 rounded-lg font-finkheavy text-xl w-72 hover:bg-orangehover'>Calculate Potential Profits</button></Link>
            </div>
          </div>
        </div>
      ) : (
